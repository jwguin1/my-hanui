...
const WHY_CARDS = [
  ...
  },
  {
    ...
    body: "누적 13,000명의 환자분이 80,000회 내원해 주셨습니다. 개원 이래 누적 9,000건 이상의 한방 다이어트 처방 경험. APCA RMSK(근골격계 초음파) 자격 보유 의료진이 초음파 진단으로 정확한 치료를 진행합니다.",
  },
  {
    badge: "접근성",
...
const FAQS = [
  ...
  },
  {
    ...
    a: "일산한의원은 개원 이래 누적 9,000건 이상의 한방 다이어트 처방 실적을 보유하고 있습니다(원내 진료기록 기준). 체계적인 한방비만치료와 대사증후군 관리를 진행합니다.",
  },
  {
